...
export const DescriptiveAlertSuccess = ({ children, closeAlert, ...props }) => {
  return (
    <div
    ...
    >
      ...
      <div className='mt-2 mb-4 text-sm text-green-700 dark:text-green-800'>
        More info about this info success goes here. This example text is going
...
export const DescriptiveAlertInfo = ({ children, closeAlert, ...props }) => {
  return (
    <div
...
export const DescriptiveAlertError = ({ children, closeAlert, ...props }) => {
  return (
    <div
...
export const DescriptiveAlertWarning = ({ children, closeAlert, ...props }) => {
  return (
    <div
...
export const DescriptiveAlertDark = ({ children, closeAlert, ...props }) => {
  return (
    <div
