...
export const AlertSuccess = ({ children, closeAlert, ...props }) => {
  return (
    <div
      id='alert-3'
...
export const AlertInfo = ({ children, closeAlert, ...props }) => {
  return (
    <div
      id='alert-1'
...
export const AlertError = ({ children, closeAlert, ...props }) => {
  return (
    <>
      <div
      ...
      <div
        className='bg-indigo-100 rounded-lg py-5 px-6 mb-3 text-base text-indigo-700 inline-flex items-center w-full'
        role='alert'
      >
        <svg
          aria-hidden='true'
      ...
      <div
        className='bg-gray-50 rounded-lg py-5 px-6 mb-3 text-base text-gray-500 inline-flex items-center w-full'
        role='alert'
      >
        <svg
          aria-hidden='true'
      ...
      <div
        className='bg-gray-300 rounded-lg py-5 px-6 mb-3 text-base text-gray-800 inline-flex items-center w-full'
        role='alert'
      >
        <svg
          aria-hidden='true'
...
export const AlertWarning = ({ children, closeAlert, ...props }) => {
  return (
    <div
      id='alert-4'
...
export const AlertDark = ({ children, closeAlert, ...props }) => {
  return (
    <div
      id='alert-5'
